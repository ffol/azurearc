...
Invoke-WebRequest ($templateBaseUrl + "arm_template/scripts/PSProfile.ps1") -OutFile $PsHome\Profile.ps1
.$PsHome\Profile.ps1
...
Invoke-WebRequest ($templateBaseUrl + "arm_template/scripts/LogInstructions.txt") -OutFile $Env:ArcJSLogsDir\LogInstructions.txt

Write-Host "Fetching Artifacts for Arc SQL Server"
Invoke-WebRequest ($templateBaseUrl + "arm_template/scripts/ArcServersLogonScript.ps1") -OutFile "$Env:ArcJSDir\ArcServersLogonScript.ps1"
Invoke-WebRequest ($templateBaseUrl + "arm_template/scripts/installArcAgentSQLSP.ps1") -OutFile "$Env:agentScript\installArcAgentSQLSP.ps1"
Invoke-WebRequest ($templateBaseUrl + "arm_template/scripts/installArcAgent.ps1") -OutFile "$Env:agentScript\installArcAgent.ps1"
Invoke-WebRequest ($templateBaseUrl + "arm_template/icons/arcsql.ico") -OutFile $Env:ArcJSIconDir\arcsql.ico
Invoke-WebRequest ($templateBaseUrl + "arm_template/scripts/testDefenderForSQL.ps1") -OutFile $Env:ArcJSDir\testDefenderForSQL.ps1
Invoke-WebRequest "https://raw.githubusercontent.com/ffol/azurearc/main/img/jumpstart_wallpaper.png" -OutFile "$Env:tempDir\wallpaper.png"
